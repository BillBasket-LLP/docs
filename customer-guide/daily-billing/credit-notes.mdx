...
<Tabs>
  <Tab title="Windows PC">
    ...
    <Frame>
      ![Credit Notes register showing one active credit note tied to a customer](/images/daily-billing/credit-note-active-windows.png)
    </Frame>
  </Tab>
  <Tab title="Phone">
    ...
    <Frame>
      ![Credit Notes register showing one active credit note tied to a customer](/images/daily-billing/credit-note-active-phone.png)
    </Frame>
  </Tab>
  <Tab title="Tablet">
    <Frame>
